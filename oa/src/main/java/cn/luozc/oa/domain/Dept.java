 ...
 * @Author: luozhicong
 * @Description:
 * @Date: Create in 11:14 2018/12/21/021
 */
@Entity
...
public class Dept implements Serializable {
    ...
    @JoinColumn(name = "MODIFIER",referencedColumnName = "USER_ID",
                foreignKey = @ForeignKey(name="FK_DEPT_MODIFIER"))//更改外键约束名称
    ...
    @JoinColumn(name = "CREATER",referencedColumnName = "USER_ID",
            foreignKey = @ForeignKey(name="FK_DEPT_CREATER"))//更改外键约束名称
    private User creater;


    /**CREATE_DATE DATE  创建时间时间*/
